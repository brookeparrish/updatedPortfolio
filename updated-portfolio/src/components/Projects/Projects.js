        ...
        <div className="container">
                ...
                <div className="card-deck mx-auto pb-4 pt-4">
                    <div className="card text-center" style={cardStyle}>
                        <div className="card-body">
                            <p className="card-title bold h3">Events with Corresponding Weather</p>
                    ...
                    <div className="card text-center" style={cardStyle}>
                        <div className="card-body">
                            <p className="card-title font-weight-bolder h3">ScrapRoom</p>
            ...
            <div className="row">
                <div className="card-deck mx-auto pb-2">
                    <div className="card text-center" style={cardStyle}>
                        <div className="card-body">
                            <p className="card-title font-weight-bolder h3">Options App</p>
